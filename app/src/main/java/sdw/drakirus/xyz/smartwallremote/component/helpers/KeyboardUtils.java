...
public class KeyboardUtils {
    ...
    private static ViewTreeObserver.OnGlobalLayoutListener ON_KEYBOARD_VISIBILTY_LISTENER = null;
    ...
    public static void removeKedKeyboardVisibilityListener(View rootLayout) {
        if (ON_KEYBOARD_VISIBILTY_LISTENER != null)
            rootLayout.getViewTreeObserver().removeOnGlobalLayoutListener(ON_KEYBOARD_VISIBILTY_LISTENER);
    }
    ...
    public static void addKeyboardVisibilityListener(View rootLayout, OnKeyboardVisibiltyListener onKeyboardVisibiltyListener) {
       ViewTreeObserver.OnGlobalLayoutListener listener = () -> {
        ...
        ON_KEYBOARD_VISIBILTY_LISTENER = listener;
